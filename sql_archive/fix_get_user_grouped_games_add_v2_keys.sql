-- Fix get_user_grouped_games to include V2 composite keys (platform_id, platform_game_id)
-- This fixes the "Missing platform_id or platform_game_id" error when viewing game achievements
