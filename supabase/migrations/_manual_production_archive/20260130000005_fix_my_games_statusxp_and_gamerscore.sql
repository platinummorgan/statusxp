-- Migration: Fix StatusXP = 0 and missing Xbox gamerscore in My Games
-- Issue: get_user_grouped_games doesn't include current_score, total_score, or rarest_achievement_rarity
--
-- Fix: Add these fields to the JSON response
