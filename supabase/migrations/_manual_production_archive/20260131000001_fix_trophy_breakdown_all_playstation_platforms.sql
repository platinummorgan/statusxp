-- Migration: Fix trophy breakdown to include all PlayStation platforms
-- Issue: user_games view only calculates trophy breakdown for PS5 (platform_id = 1)
--        PS4, PS3, and PSVita games show 0 trophies even though data exists
--
-- Fix: Change platform_id filter to include all PlayStation platforms (1, 2, 5, 9)
