-- Fix get_user_grouped_games to include last_trophy_earned_at and last_played_at in platforms JSON
-- This fixes sorting by "Last Trophy" on the My Games screen
...
BEGIN
  ...
  SELECT
    ...
    ARRAY[jsonb_build_object(
      ...
      -- FIX: Include last_played_at and last_trophy_earned_at in the platforms JSON
