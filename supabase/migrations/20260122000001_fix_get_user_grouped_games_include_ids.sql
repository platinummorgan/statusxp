-- Migration: Fix get_user_grouped_games to include platform_id and platform_game_id
-- Issue #6: My Games achievements error - Missing platform_id or platform_game_id for V2 schema
-- The function was not returning platform_id and platform_game_id in the platforms JSONB array
...
BEGIN
  ...
  SELECT 
    ...
    ARRAY[jsonb_build_object(
      ...
      'last_trophy_earned_at', ug.last_trophy_earned_at,
      'rarest_achievement_rarity', NULL
    )] as platforms,
