-- Migration: Fix StatusXP refresh overcount (per-game totals)
-- Date: 2026-01-25

BEGIN;
-- Refresh for all users without multiplying per achievement
...
END;
$$;
-- Refresh for a single user without multiplying per achievement
