-- Fix Hall of Fame period generation when weekly overrides exist.
-- Use default Tuesday->Tuesday boundaries for historical periods, while still
-- including any historical override windows explicitly.
