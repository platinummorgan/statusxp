-- Migration: Fix StatusXP showing as 0 in My Games
-- Issue: get_user_grouped_games function hardcodes statusxp to 0
-- 
-- Solution: Calculate actual StatusXP by summing base_status_xp from earned achievements
