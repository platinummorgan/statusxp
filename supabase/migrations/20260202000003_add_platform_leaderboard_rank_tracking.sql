-- Add Rank Movement Tracking for Platform-Specific Leaderboards
-- This adds the same rank tracking functionality to PSN, Xbox, and Steam leaderboards
-- that we already have for StatusXP leaderboard
...
-- Add documentation
COMMENT ON TABLE psn_leaderboard_history IS 
'Historical snapshots of PSN platinum leaderboard rankings for tracking movement over time';

COMMENT ON TABLE xbox_leaderboard_history IS 
'Historical snapshots of Xbox gamerscore leaderboard rankings for tracking movement over time';

COMMENT ON TABLE steam_leaderboard_history IS 
'Historical snapshots of Steam achievement leaderboard rankings for tracking movement over time';
