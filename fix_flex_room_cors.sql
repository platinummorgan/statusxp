...
-- This updates the flex room RPC functions to return proxied URLs instead of external URLs
-- This fixes CORS issues on web for game covers and achievement icons

-- 1. Update get_rarest_achievement_v2
DROP FUNCTION IF EXISTS public.get_rarest_achievement_v2(uuid);
...
-- 2. Update get_most_time_sunk_game_v2
DROP FUNCTION IF EXISTS public.get_most_time_sunk_game_v2(uuid);
...
-- 3. Update get_sweatiest_platinum_v2
DROP FUNCTION IF EXISTS public.get_sweatiest_platinum_v2(uuid);
...
-- 4. Update get_recent_notable_achievements_v2
DROP FUNCTION IF EXISTS public.get_recent_notable_achievements_v2(uuid, integer);
...
-- Done! Now reload your flex room page and images should work (if proxied URLs exist in DB)
