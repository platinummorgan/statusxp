...
class BiometricAuthService {
    ...
    try {
      ...
      final authenticated = await _localAuth.authenticate(
        ...
        options: const AuthenticationOptions(
          ...
          biometricOnly:
              false, // Allow fallback to PIN/password if biometric fails
        ),
      );
      ...
      if (e.code == auth_error.notAvailable) {
        ...
        errorMessage =
            'Biometric authentication is permanently locked. Please unlock your device.';
      } else if (e.code == auth_error.passcodeNotSet) {
        errorMessage =
            'No device passcode set. Please set up a PIN, pattern, or password first.';
      } else {
  ...
  Future<void> storeLegacyCredentials(String email, String password) async {
  ...
  Future<bool> hasStoredCredentials() async {
    return await hasLegacyStoredCredentials();
  }

  /// Clear stored credentials (LEGACY)
  Future<void> clearLegacyStoredCredentials() async {
  ...
  Future<void> clearStoredCredentials() async {
    await clearLegacyStoredCredentials();
  }
}
